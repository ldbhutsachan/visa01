    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title" style="font-family:phetsarath OT;"><b>ເພີ້ມປະເພດລາຍຈ່າຍ </b></h4>
            	
          	</div>
          	 	<div class="modal-body">
          	 	
          	<div class="modal-body">
          		<form:form class="form-horizontal"  attribute="Expensestype" autocomplete="off" method="POST"
          		 action ="${pageContext.request.contextPath}/Expenses/save" enctype="multipart/form-data">
				<div class="form-group">
				<div class="col-xs-6 col-sm-10">
				<label>ຊື່ປະເພດລາຍຈ່າຍ</label>
